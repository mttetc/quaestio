...
export function SubscriptionList({ subscriptions, onUnsubscribe, isUnsubscribing }: SubscriptionListProps) {
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => handleSelect(subscription.id, checked as boolean)}
                                    />
                                    <div>
                                        <div className="font-medium">{subscription.sender}</div>
                                        <div className="text-sm text-muted-foreground">{subscription.domain}</div>
                                    </div>
                                </div>
